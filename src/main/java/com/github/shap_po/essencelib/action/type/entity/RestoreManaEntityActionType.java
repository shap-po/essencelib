...
public class RestoreManaEntityActionType extends EntityActionType {

    public static final TypedDataObjectFactory<RestoreManaEntityActionType> DATA_FACTORY = TypedDataObjectFactory.simple(
        new SerializableData()
            .add("amount", SerializableDataTypes.FLOAT),
        data -> new RestoreManaEntityActionType(data.getFloat("amount")),
    ...
    public RestoreManaEntityActionType(float amount) {
        this.amount = amount;
    }
    ...
    public void accept(EntityActionContext context) {
        ...
        instance.setBaseValue(Math.min(max, current + amount));
    }

    @Override
    public @NotNull ActionConfiguration<?> getConfig() {
        return EssenceLibEntityActionTypes.RESTORE_MANA;
    }
}
